  ...
  <body>
      ...
      <div class="panel panel-primary">
		  ...
		  <div class="panel-body">
			<h3><p align="center" class="text-primary"><img src="ui/img/logo.jpg" class="img-responsive" height="150" width="150"/><?php echo $_SESSION['welcome'];?></p></h3>
			<center class="text-primary">Aplikasi <?php echo $_SESSION['judul'];?> didevelop oleh <?php echo $_SESSION['by'];?>.</center>
		  </div>
