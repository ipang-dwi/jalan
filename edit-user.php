							...
							<form role="form" method="post" action="edit-u.php?id=<?php echo $_GET['id'];?>">
                                    <div class="box-body">
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="user" id="user" placeholder="Username" value="<?php echo $row['user'];?>" required >
                                        </div>
										<div class="form-group">
                                            <label for="pass">Password</label>
                                            <input type="password" class="form-control" name="pass" id="pass" placeholder="Password" value="<?php echo $row['pass'];?>" required >
                                        </div>				
										<div class="form-group">
