	...
	<div class="container">
      ...
      <div class="panel panel-primary">
		  ...
		  <div class="panel-heading">Data User</div>
						<?php
							$kriteria = $mysqli->query("select * from user");
							if(!$kriteria){
		  ...
		  <div class="panel-body table-responsive">
			<a class='btn btn-primary' href='add-user.php'> Tambah Data User</a><br /><br />
			...
			<tbody>
										<?php
												...
												while ($row = $kriteria->fetch_assoc()) {
													...
													echo '<td>'.$row["pass"].'</td>';
													echo '<td>';
													if($row["level"]=='admin') echo '<span class="label label-success">';
													else echo '<span class="label label-warning">';
													echo ucfirst($row["level"]).'</span></td>';
													...
													?>
														  ...
														  <a href="del-u.php?id=<?php echo $row['id'];?>" onClick="return confirm('Menghapus data ke-<?php echo $i-1;?> ?');" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Delete</a></td>
													<?php
													echo '</tr>';
												}
										?>
